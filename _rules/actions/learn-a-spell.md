...
- Attempt a skill check for the skill corresponding to your tradition (DC determined by the GM, often close to the DC on [Table 4-3: Learning a Spell](learning-a-spell.md)). [Uncommon](uncommon.md) or [rare](rare.md) spells have [higher DCs](dc-adjustments.md); full guidelines for the GM appear on page 503.
