...
Change the [human](human.md) trait to [dwarf](dwarf.md).
...
Change the [human](human.md) trait to [elf](elf.md).

- Add Elven to the NPC's languages.
- Add [low-light vision](low-light-vision.md).
- Increase the NPC's Speed by 5 feet.

#### Gnome
<sup>GMG p. 204</sup>

Change the [human](human.md) trait to [gnome](gnome.md).
...
Change the [human](human.md) trait to [goblin](goblin.md).
...
Change the [human](human.md) trait to [halfling](halfling.md).
