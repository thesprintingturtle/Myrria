...
==[Uncommon](uncommon.md)== ==[Emotion](emotion.md)== ==[Fear](../../Arcane_Tradition/Level%201/Fear.md)== ==[Illusion](illusion.md)== ==[Mental](mental.md)== ==[Sorcerer](rules/traits/sorcerer.md)== ==[Visual](visual.md)==
