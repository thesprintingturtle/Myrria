...
==[Uncommon](uncommon.md)== ==[Cursebound](../../../Traits/Cursebound.md)== ==[Divination](divination.md)== ==[Emotion](emotion.md)== ==[Fear](../../Arcane_Tradition/Level%201/Fear.md)== ==[Mental](mental.md)== ==[Oracle](../../../Traits/Oracle.md)==
