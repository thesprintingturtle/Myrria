...
==[Uncommon](uncommon.md)== ==[Bard](rules/traits/bard.md)== ==[Composition](composition.md)== ==[Enchantment](enchantment.md)== ==[Incapacitation](incapacitation.md)== ==[Mental](mental.md)== ==[Sonic](sonic.md)==
...
**Critical Failure** The target gains the [Minion](minion.md) trait and is [Controlled](../../../Conditions/Controlled.md) by you. This effect ends if a hostile action is used against the affected creature, or if you direct the creature to use any action that causes it harm.