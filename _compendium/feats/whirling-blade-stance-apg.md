...
You enter a mindful stance that creates a deep connection between you and your monk weapons, allowing you to manipulate them with your ki even at a distance. All melee monk weapons you wield with the [finesse](finesse.md) trait gain the [thrown 10 feet](thrown.md) trait (unless they already have the [thrown](thrown.md) trait with a greater range)
