...
This is a [misfortune](misfortune.md) effect. If you do so, you enter a curse maelstrom state. If the [misfortune](misfortune.md) effect is somehow canceled or negated (by a [fortune](fortune.md) effect, for example), you don't enter a curse maelstrom state.

In addition, the curse is jealous of its place within your soul and gladly lashes out whenever others dare to usurp that position, granting you its power without the usual price. If a foe places a [misfortune](misfortune.md) effect on your roll and the effect applies to your roll, you enter a curse maelstrom state, and if you fail a saving throw against a foe's [curse](curse.md) effect and are affected by the curse, you also enter a curse maelstrom state.
...
%% #imported/compendium/src/pf2e/da #trait/feat/archetype #trait/feat/dedication #trait/rarity/rare %%
