...
The hut can't attack or attempt skill checks. You can give the hut a command as a single action, which has the [auditory](auditory.md) and [concentrate](concentrate.md) traits; after 1 round of reconfiguring itself, the hut then follows that command until you give it a different command.
...
- **Hide** The hut appears to be a normal, mundane object of its type. This is a 10th-level [illusion](illusion.md) effect
