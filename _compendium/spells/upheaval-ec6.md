...
> - **Critical Failure** The creature takes the full collapse damage and is [restrained](conditions.md#Restrained) by debris until it successfully Escapes (DC equal to the spell's save DC).
