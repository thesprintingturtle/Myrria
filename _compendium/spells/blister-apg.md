...
> - **Success** The target grows one blister. You can spend a single action, which has the [concentrate](concentrate.md) trait, to pop a blister. The target and each creature in a 15-foot cone originating from the target takes `7d6` acid damage (basic Fortitude save). You choose the direction of the cone, which can't include the target. When no blisters are left, the spell ends.
