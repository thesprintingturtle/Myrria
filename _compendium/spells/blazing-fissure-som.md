...
> - **Failure** The creature takes full damage, and it falls [prone](conditions.md#Prone).
> - **Critical Failure** The target takes double damage, and it falls [prone](conditions.md#Prone).
