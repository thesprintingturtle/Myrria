...
The wall blocks physical effects from passing through it, and because it's made of force, it blocks incorporeal and ethereal creatures as well. [Teleportation](teleportation.md) effects can pass through the barrier, as can [visual](visual.md) effects (since the wall is [invisible](conditions.md#Invisible))
