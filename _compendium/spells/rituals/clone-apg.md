...
> [!success-degree] 
> - **Critical Success** The cloning process is successful. When the soul occupies the completed clone, it is [clumsy](conditions.md#Clumsy), [drained](conditions.md#Drained), [doomed](conditions.md#Doomed), and [enfeebled](conditions.md#Enfeebled) for 1 week; these conditions can't be removed or reduced by any means until the week has passed.
